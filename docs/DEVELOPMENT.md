...
Maintainer notes for building and changing The Stat Method. Outside contributors should
read [`CONTRIBUTING.md`](../CONTRIBUTING.md) instead — calculators and articles are added
...
1. **Write the math in `src/engine/`.** Pure functions, no React, no DOM. Every formula
